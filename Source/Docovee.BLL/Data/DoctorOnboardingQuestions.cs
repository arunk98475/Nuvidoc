...
public static class DoctorOnboardingQuestions
{
    public static IReadOnlyList<DoctorOnboardingQuestion> All { get; } = new List<DoctorOnboardingQuestion>
    {
        ...
        new(47, "Patient Experience", "What is your average Google / Healthgrades review score?", "Number", "e.g. 4.8", true),
        new(48, "Patient Experience", "How many reviews do you have total (across all platforms)?", "Number", "Approximate count", true),
        new(49, "Patient Experience", "What is your new patient intake experience like? Walk us through it.", "Long Text", "Free text", false),
